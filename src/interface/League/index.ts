...
export type IMiniSeriesDTO = IMiniSeriesDTO_v4;
export type ILeagueListDTO = ILeagueListDTO_v4;
export type ILeagueItemDTO = ILeagueItemDTO_v4;
export type ILeagueEntryDTO = ILeagueEntryDTO_v4;