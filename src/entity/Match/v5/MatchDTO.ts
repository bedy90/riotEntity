...
export class PerkStyleSelectionDTO implements IPerkStyleSelectionDTO {
    perk!: number;
    var1!: number;
    var2!: number;
    var3!: number;
...
export class ObjectivesDTO implements IObjectivesDTO {
    baron!: IObjectiveDTO;
    champion!: IObjectiveDTO;
    dragon!: IObjectiveDTO;
    inhibitor!: IObjectiveDTO;
...
//     static isMatchDTO(obj: any): obj is IMatchDTO {
//         return (
//           typeof obj === 'object' &&
//           MatchChecker.isMetadataDTO(obj.metadata) &&
//           MatchChecker.isInfoDTO(obj.info)
//           // Ajoutez d'autres vérifications de propriétés selon vos besoins
//         );
//       }

//       private static isMetadataDTO(obj: any): obj is IMetadataDTO {
//         return (
//           typeof obj === 'object' &&
//           typeof obj.dataVersion === 'string' &&
...
//       private static isInfoDTO(obj: any): obj is IInfoDTO {
//         return (
//           typeof obj === 'object' &&
//           typeof obj.gameCreation === 'number' &&
//           typeof obj.gameDuration === 'number'
//           // Ajoutez d'autres vérifications de propriétés selon vos besoins
//         );
//       }
...
//       static isPerksDTO(obj: any): obj is IPerksDTO {
//         return (
//           typeof obj === 'object' &&
//           MatchChecker.isPerkStatsDTO(obj.statPerks) &&
//           Array.isArray(obj.styles) &&
//           obj.styles.every((s: any) => MatchChecker.isPerkStyleDTO(s))
//           // Ajoutez d'autres vérifications de propriétés selon vos besoins
//         );
//       }

//       private static isPerkStatsDTO(obj: any): obj is IPerkStatsDTO {
//         return (
//           typeof obj === 'object' &&
//           typeof obj.defense === 'number' &&
//           typeof obj.flex === 'number' &&
//           typeof obj.offense === 'number'
//           // Ajoutez d'autres vérifications de propriétés selon vos besoins
//         );
//       }

//       private static isPerkStyleDTO(obj: any): obj is IPerkStyleDTO {
//         return (
//           typeof obj === 'object' &&
//           typeof obj.description === 'string' &&
//           Array.isArray(obj.selections) &&
//           obj.selections.every((s: any) => MatchChecker.isPerkStyleSelectionDTO(s)) &&
//           typeof obj.style === 'number'
//           // Ajoutez d'autres vérifications de propriétés selon vos besoins
//         );
//       }

//       private static isPerkStyleSelectionDTO(obj: any): obj is IPerkStyleSelectionDTO {
//         return (
//           typeof obj === 'object' &&
//           typeof obj.perk === 'number' &&
//           typeof obj.var1 === 'number' &&
//           typeof obj.var2 === 'number' &&
//           typeof obj.var3 === 'number'
//           // Ajoutez d'autres vérifications de propriétés selon vos besoins
//         );
//       }
// }