...
//     const parser: InterfaceParser = new InterfaceParser(this.project, type, this.entitiesData);
//     parser.ParseFiles(filesFolderPath);
...
//     const parser: InterfaceParser = new InterfaceParser(this.project, type, this.entitiesData);
//     parser.ParseFiles(filesFolderPath, true);
